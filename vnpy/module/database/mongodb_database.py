...
class MongodbDatabase(BaseDatabase):
    ...
    def __init__(self) -> None:
        """"""
        # 读取配置
        self.database: str = os.environ.get("database.database")
        self.host: str = os.environ.get("database.host")
        self.port: int = int(os.environ.get("database.port"))
        self.username: str = os.environ.get("database.user")
        self.password: str = os.environ.get("database.password")
