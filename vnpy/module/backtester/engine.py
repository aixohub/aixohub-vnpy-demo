...
from vnpy.trader.database import BaseDatabase, get_database, get_database_v2



from .locale import _
from ..strategy_cta import CtaTemplate, TargetPosTemplate
from ..strategy_cta.backtesting import BacktestingEngine
from ..strategy_cta.base import BacktestingMode
...
class BacktesterEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine) -> None:
        ...
        self.database: BaseDatabase = get_database_v2()
